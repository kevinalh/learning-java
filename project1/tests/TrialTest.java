...
public class TrialTest
{
    ...
    {
        assertEquals(trial.getMaxLeftWrist(0), 5, 0.001);
        assertEquals(trial.getMaxLeftWrist(1), 3, 0.001);
        assertEquals(trial.getMaxLeftWrist(2), 11, 0.001);
    }

    @Test
    public void testGetMinLeftWrist()
    {
        assertEquals(trial.getMinLeftWrist(0), 1, 0.001);
        assertEquals(trial.getMinLeftWrist(1), 1, 0.001);
        assertEquals(trial.getMinLeftWrist(2), 1, 0.001);
    }

    @Test
    public void testGetAverageLeftWrist()
    {
        assertEquals(trial.getAverageLeftWrist(0), 3, 0.001);
        assertEquals(trial.getAverageLeftWrist(1), 2, 0.001);
        assertEquals(trial.getAverageLeftWrist(2), 14.0/3.0, 0.001);
    }
