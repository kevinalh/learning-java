...
public class State
{
    ...
    public State(String strg)
    {
        ...
        try
        {
            ...
            leftWrist = new Point3D(new GeneralValue(substrings[1]), new GeneralValue(substrings[2]),
                    new GeneralValue(substrings[3]));
            rightWrist = new Point3D(new GeneralValue(substrings[4]), new GeneralValue(substrings[5]),
                    new GeneralValue(substrings[6]));
        }
